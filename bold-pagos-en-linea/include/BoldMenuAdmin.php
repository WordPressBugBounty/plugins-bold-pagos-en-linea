...
class BoldMenuAdmin
{
    ...
    private function addAssetsAdmin(): void
    {
        wp_register_script( 'woocommerce_bold_admin_panel_js', plugins_url( '/../assets/js/admin-panel.js', __FILE__ ),
            array('bold-assets-js', 'jquery'), '3.1.5', true );
        wp_enqueue_script( 'woocommerce_bold_admin_panel_js' );
        wp_enqueue_style( 'woocommerce_bold_admin_panel_css', plugin_dir_url( __FILE__ ) . '../assets/css/bold_admin_panel_style.css', false, '3.1.5', 'all' );

        wp_register_script( 'woocommerce_bold_icons-dark-ui', BoldConstants::URL_CHECKOUT.'/library/ui-kit.js?layout=vertical&type=slider&target=bold-config-dark-icons', null, '3.1.5', true );
        wp_enqueue_script( 'woocommerce_bold_icons-dark-ui' );
        wp_register_script( 'woocommerce_bold_icons-light-ui', BoldConstants::URL_CHECKOUT.'/library/ui-kit.js?layout=vertical&type=slider&theme=dark&target=bold-config-light-icons', null, '3.1.5', true );
        wp_enqueue_script( 'woocommerce_bold_icons-light-ui' );

        wp_enqueue_media();
        wp_enqueue_script('woocommerce_bold_media_uploader', plugins_url( '/../assets/js/bold-media-uploader.js', __FILE__ ), ['jquery', 'wp-i18n'], '3.1.5', true);
