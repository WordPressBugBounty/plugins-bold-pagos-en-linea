...
class BoldWoo {
	...
	public function load_scripts_js() {
		wp_register_script( 'woocommerce_bold_admin_notifications', plugin_dir_url( __FILE__ ) . '../assets/libraries/awesome-notifications/dist/index.var.js', [], '3.0.5', true );
		wp_enqueue_script( 'woocommerce_bold_admin_notifications' );
	
		wp_register_script( 'woocommerce_bold_gateway_js', plugin_dir_url( __FILE__ ) . '../assets/js/admin-index.js', [ 'jquery', 'woocommerce_bold_admin_notifications' ], '3.0.5', true );
	...
	public function load_scripts_css() {
		wp_enqueue_style( 'woocommerce_bold_gateway_css', plugin_dir_url( __FILE__ ) . '../assets/css/bold_woocommerce_styles.css', false, '3.0.5', 'all' );
	}
