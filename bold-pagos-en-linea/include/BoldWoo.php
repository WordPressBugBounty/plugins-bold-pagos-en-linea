...
class BoldWoo {
	...
	public function load_scripts_js() {	
		wp_register_script( 'woocommerce_bold_gateway_js', plugin_dir_url( __FILE__ ) . '../assets/js/admin-index.js', [ 'jquery', 'bold-assets-js' ], '3.1.9', true );
	...
	public function load_scripts_css() {
		wp_enqueue_style( 'woocommerce_bold_gateway_css', plugin_dir_url( __FILE__ ) . '../assets/css/bold_woocommerce_styles.css', false, '3.1.9', 'all' );
	}
